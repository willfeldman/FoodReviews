...
<html>
    ...
    <body style="padding: 20px;">
        ...
        <div>
            <h1>Reviews of <?php echo $database_connection->findReviewFood($food) ?></h1>
            <hr>
            <ul class="list-group">
                <?php 
                    foreach ($database_connection->findAllReviewByFoodId($food) as $review) {
